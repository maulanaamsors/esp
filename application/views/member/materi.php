...
<div class="row">
	...
	<div class="col-sm-2">
		<ul>
			<li><button class="btn btn-info" id="materi1">Materi 1</button></li>
	...
	<div class="col-sm-7 border materi" hidden="" id="materi22">
		Materi 2
	</div>
	<div class="col-sm-7 border materi" hidden="" id="materi33">
		Materi 3
	</div>
	<div class="col-sm-2">
	</div>
